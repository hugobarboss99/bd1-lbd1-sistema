...
// USUARIOS_ADMIN e ANUNCIOS_IRREGULARES_ADMIN foram removidos: modelavam
// campos que nao existem no contrato real (status_conta virou "status",
// is_admin/telefone/criado_em/motivo_bloqueio nao existem na resposta do
// backend, e o conceito de status "IRREGULAR" com "motivo" nao existe -
// o admin_router.py so reconhece ATIVO/ENCERRADO). As paginas de admin
// devem consumir os endpoints reais (ver listarUsuariosAdmin,
// listarAnunciosAdmin etc. em api.js).